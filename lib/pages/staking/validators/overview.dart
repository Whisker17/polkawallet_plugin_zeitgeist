...
import 'package:polkawallet_plugin_zeitgeist/pages/staking/validators/nominatePage.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/validators/validator.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/validators/validatorDetailPage.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/validators/validatorListFilter.dart';
import 'package:polkawallet_plugin_zeitgeist/polkawallet_plugin_zeitgeist.dart';
import 'package:polkawallet_plugin_zeitgeist/service/walletApi.dart';
import 'package:polkawallet_plugin_zeitgeist/store/staking/types/validatorData.dart';
import 'package:polkawallet_plugin_zeitgeist/utils/format.dart';
...
class _StakingOverviewPageState extends State<StakingOverviewPage> {
  ...
  Widget _buildTopCard(BuildContext context) {
    final dicStaking =
        I18n.of(context)!.getDic(i18n_full_dic_zeitgeist, 'staking')!;
    final symbol = (widget.plugin.networkState.tokenSymbol ?? ['ZTG'])[0];
