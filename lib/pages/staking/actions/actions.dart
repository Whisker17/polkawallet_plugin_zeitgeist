...
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/bondExtraPage.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/payoutPage.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/rebondPage.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/redeemPage.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/rewardDetailPage.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/rewardsChart.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/setControllerPage.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/setPayeePage.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/stakePage.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/stakingDetailPage.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/unbondPage.dart';
...
class _StakingActions extends State<StakingActions> {
      ...
      return Container(
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: i.success!
                ? SvgPicture.asset(
                    'packages/polkawallet_plugin_zeitgeist/assets/images/staking/ok.svg')
                : SvgPicture.asset(
                    'packages/polkawallet_plugin_zeitgeist/assets/images/staking/error.svg'),
          ),
          title: Text(i.call!),
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: SvgPicture.asset(
                'packages/polkawallet_plugin_zeitgeist/assets/images/staking/${isReward ? 'reward' : 'slash'}.svg'),
          ),
  ...
  Widget _buildActionCard() {
    var dic = I18n.of(context)!.getDic(i18n_full_dic_zeitgeist, 'staking');
    ...
    final decimals = (widget.plugin.networkState.tokenDecimals ?? [10])[0];
...
class RowAccount02 extends StatelessWidget {
  ...
  void _showActions(BuildContext context) {
    final dic = I18n.of(context)!.getDic(i18n_full_dic_zeitgeist, 'staking')!;
...
class StakingInfoPanel extends StatelessWidget {
  ...
  void _showUnlocking(BuildContext context) {
    final dic = I18n.of(context)!.getDic(i18n_full_dic_zeitgeist, 'staking');
    final dicGov = I18n.of(context)!.getDic(i18n_full_dic_zeitgeist, 'gov');
      ...
      builder: (BuildContext context) => CupertinoActionSheet(
        ...
        cancelButton: CupertinoActionSheetAction(
          child: Text(I18n.of(context)!
              .getDic(i18n_full_dic_zeitgeist, 'common')!['cancel']!),
          onPressed: () {
            Navigator.pop(context);
          },
        ),
                  ...
                  builder: (BuildContext context) => CupertinoActionSheet(
                    ...
                    cancelButton: CupertinoActionSheetAction(
                      child: Text(I18n.of(context)!.getDic(
                          i18n_full_dic_zeitgeist, 'common')!['cancel']!),
                      onPressed: () {
                        Navigator.pop(context);
                      },
                    ),
