...
import 'package:polkawallet_plugin_zeitgeist/pages/staking/actions/actions.dart';
import 'package:polkawallet_plugin_zeitgeist/pages/staking/validators/overview.dart';
...
import '../polkawallet_plugin_zeitgeist.dart';
        ...
        child: Column(
          children: <Widget>[
            ...
            Expanded(
              child: _tab == 1
                  ? StakingOverviewPage(
                      widget.plugin as PluginZeitgeist, widget.keyring)
                  : StakingActions(
                      widget.plugin as PluginZeitgeist, widget.keyring),
            ),
          ],
